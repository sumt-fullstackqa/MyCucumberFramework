...
public class Addcustomer {
	...
	public void enter_valid_Company_name_email_first_name_last_name_contact_number_corporate_contact_number_tax_id_postal_code_Address_and_city()
			throws Exception {
		// Write code here that turns the phrase above into concrete actions
		addcustomer.companySelectvalues(ConfigProperties.FIRSTNAME, ConfigProperties.LASTNAME,
				ConfigProperties.CONTACTNUMBER, ConfigProperties.CORPORATECONTACTNUMBER, ConfigProperties.TAXID,
				ConfigProperties.POSTALCODE, ConfigProperties.ADDRESS, ConfigProperties.CITY);
	}
