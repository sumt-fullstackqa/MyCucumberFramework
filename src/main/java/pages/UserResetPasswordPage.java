...
public class UserResetPasswordPage {
	...
	public void clickonthreedottediconandresetpasswordlinkforuser() throws Exception {
	...
	public void userresetpasswordSelectvalues(String New_Password_1, String Confirm_Password_1)
	...
	public void clickonokbuttonforresetpasswordforuser() throws Exception {

		okbuttonresetpassword.click();
		Thread.sleep(5000);
	}

	public void Successmessageforresetpassworduser() throws Exception {
